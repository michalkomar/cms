<?php
	...
	namespace Wunderman\CMS\Carousel\PrivateModule;
	...
	class Service implements ComposedPageExtension
	{
		...
		public function addItem(Form &$form)
		{
			...
			$item->addSelect('item', 'New item', $this->readCarousels());
		...
		{
			return $this->em->getRepository('\App\Entity\Carousel')->findPairs(array('status' => 'ok'), 'name', array(), 'id');
		}
