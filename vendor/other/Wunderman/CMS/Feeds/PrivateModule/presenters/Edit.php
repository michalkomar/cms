<?php
	...
	use App\PrivateModule\FeedsModule\Component\EditItemForm;
	...
	class EditPresenter extends \App\PrivateModule\PrivatePresenter
	{
		...
		{
			$this->getTemplate()->box = $this->box = $this->feedsModel->readBox($id);
		}
		...
		{
			$this->item = $this->feedsModel->readBoxItem($this->getParameter('editItemId'));
		}

		public function handleMoveRight()
		{
			$item = $this->feedsModel->readBoxItem($this->getParameter('moveItemId'));
		...
		{
			return new EditItemForm($this->attachmentService, $this->feedsModel, $this->box,
